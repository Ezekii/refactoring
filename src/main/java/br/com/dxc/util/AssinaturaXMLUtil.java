...
//
//import br.com.cresol.colmeia.core.util.TipoCodificacao;
//
...
//	 * @throws Exception
//	 */
//	public String assinarElemento(String xmlSource, String nomeElemento,
//			CertificadoBean certificadoBean) throws Exception {
//		Document document = documentFactory(xmlSource);
//		Element elemento = (Element) document
//				.getElementsByTagName(nomeElemento).item(0);
...
//	 * @throws Exception
//	 */
//	public String assinarElementoPai(String xmlSource, String nomeElemento,
//			CertificadoBean certificadoBean) throws Exception {
//		Document document = documentFactory(xmlSource);
//		Element elemento = (Element) document
//				.getElementsByTagName(nomeElemento).item(0);
//		elemento.setIdAttribute("id", true);
//		return assinarXML(document, elemento.getParentNode(), nomeElemento,
//				certificadoBean);
//	}
//
//	/**
...
//	 */
//	private String assinarXML(Document document, Node assinar,
//			String nomeElemento, CertificadoBean certificadoBean)
...
//				new ByteArrayInputStream(xml.getBytes(TipoCodificacao.UTF
//						.getCodificacao())));
//		return document;
//	}
//
...
//				TipoCodificacao.UTF.getCodificacao());
