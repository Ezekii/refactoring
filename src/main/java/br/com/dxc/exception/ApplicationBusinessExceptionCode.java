...
public enum ApplicationBusinessExceptionCode implements ExceptionCode {
    ...
    CRESOL_ERROR_JOB_ESTA_EXECUTANDO("1015", Severity.WARNING),
    CRESOL_ERROR_JOB_JA_EXISTE_NAO_RESTARAVEL("1016", Severity.WARNING),
    CRESOL_COB_ERROR_JOB_CONCLUIDO("1017", Severity.WARNING),
    CRESOL_ERROR_JOB_PARAMETRO_INVALIDO("1018", Severity.WARNING),
    CRESOL_ERROR_JOB_RUN("1019", Severity.WARNING),
    CRESOL_ERROR_JOB_NAO_ENCONTRADO("1020", Severity.WARNING),
    CRESOL_ERROR_JOB_NAO_RESTARTAVEL("1021", Severity.WARNING),
    CRESOL_ERROR_JOB_RESTART("1022", Severity.WARNING),
    CRESOL_ERROR_JOB_NAO_INTERROMPIDO("1023", Severity.WARNING),
    CRESOL_ERROR_JOB_STOP("1024", Severity.WARNING),
    CRESOL_ERROR_JOB_NAO_ABORTADO("1025", Severity.WARNING),
    CRESOL_ERROR_JOB_ABANDON("1026", Severity.WARNING)
    ;
